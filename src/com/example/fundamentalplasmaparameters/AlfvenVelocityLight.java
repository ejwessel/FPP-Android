...
public class AlfvenVelocityLight extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.alfven_velocity_light);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.alfven_velocity_light, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem menuItem){       
        startActivity(new Intent(AlfvenVelocityLight.this, DimensionlessActivity.class));
        onBackPressed();
        return true;
    }
	...
	private final TextWatcher inputWatcher = new TextWatcher() {
        ...
        public void calculate(){
        	if(!(muInput.getText().toString().equals("")
	        	...
	        	double vValue = 7.28 * Math.pow(muValue, -.5) * Math.pow(nValue, -.5) * bValue; 	
